...
namespace ModernRetailAPI.Models
{
    ...
    public class MDRdaywiseOutput
    {
        public string status { get; set; }
        public string message { get; set; }
        public int toal_shopvisit_count { get; set; }
        public int avg_shopvisit_count { get; set; }
        public List<MDRdaywiseList> date_list { get; set; }
    }

    public class MDRdaywiseList
    {
    ...
    public class ITCMDRdaywiseInput
    {
        public int? user_id { get; set; }
        public string from_date { get; set; }
        public string to_date { get; set; }
    ...
    public class ITCMDRdaywiseOutput
    {
        public string status { get; set; }
        public string message { get; set; }
        public int toal_shopvisit_count { get; set; }
        public int avg_shopvisit_count { get; set; }
        public List<ITCMDRdaywiseList> date_list { get; set; }
    }

    public class ITCMDRdaywiseList
    {
        public string date { get; set; }
