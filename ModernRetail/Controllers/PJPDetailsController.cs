...
{
    public class PJPDetailsController : Controller
    {
        PJPListDetailsBL obj = new PJPListDetailsBL();
        public ActionResult PJPListIndex()
        {
            EntityLayer.CommonELS.UserRightsForPage rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/PJPListIndex", "PJPDetails");
        ...
        public IEnumerable GetDataDetails(string Is_PageLoad)
        {
            ...
            if (Is_PageLoad != "Ispageload")
            {
                ...
                var q = from d in dc.MR_PJPLIST_REPORTs
