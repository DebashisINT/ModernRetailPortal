    ...
    public class BeatPlanController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                DataTable dtbranch = lstuser.GetHeadBranchList(Convert.ToString(Session["MRuserbranchHierarchy"]), "HO");
                DataTable dtBranchChild = new DataTable();
                if (dtbranch.Rows.Count > 0)
                {
                    dtBranchChild = lstuser.GetChildBranch(Convert.ToString(Session["MRuserbranchHierarchy"]));
                ...
                EntityLayer.CommonELS.UserRightsForPage rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Index","BeatPlan");
        ...
        public ActionResult SaveBeatPlan(saveBeatPlan data)
        {
            try
            {
                ...
                proc.AddPara("@USER_ID", data.EmpCntId);
        ...
        public ActionResult PartialBeatPlanGridList(BeatPlanModel model)
        {
            EntityLayer.CommonELS.UserRightsForPage rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Index", "BeatPlan");
            ViewBag.CanView = rights.CanView;
            ViewBag.CanExport = rights.CanExport;
            ...
            //return PartialView(GetDataDetails(Is_PageLoad));
            return PartialView("PartialBeatPlanGridList", GetDataDetails(Is_PageLoad));
        }
        ...
        public IEnumerable GetDataDetails(string Is_PageLoad)
        {
            ...
            if (Is_PageLoad != "Ispageload")
            {
                ...
                var q = from d in dc.MR_BEATPLANLISTs
        ...
        public ActionResult ExporBeatList(int type)
        {
            switch (type)
            {
                case 1:
                ...
                if (Extension.ToUpper() == ".XLS" || Extension.ToUpper() == ".XLSX")
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            ...
                            proc.AddPara("@USERID", Convert.ToInt32(Session["MRuserid"]));
                            dtCmb = proc.GetTable();
