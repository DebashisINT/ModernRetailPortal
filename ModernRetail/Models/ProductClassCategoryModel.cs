...
{
    public class ProductClassCategoryModel
    {
        public string Is_PageLoad { get; set; }

        public int SaveProductClassCategory(string ShortName, string user, string ID = "0", string Name = "", string Description = "")
        {
            ...
            try
            {
                ...
                sqlcmd.Parameters.AddWithValue("@ProductClass_Code", ShortName);
                sqlcmd.Parameters.AddWithValue("@USER_ID", user);
                sqlcmd.Parameters.AddWithValue("@ID", ID);
                sqlcmd.Parameters.AddWithValue("@ProductClass_Name", Name);
                sqlcmd.Parameters.AddWithValue("@ProductClass_Description", Description);
        ...
        public int Delete(string Id)
        {
            int i;
            int rtrnvalue = 0;
            ProcedureExecute proc = new ProcedureExecute("PRC_MR_PRODUCTCLASSCATEGORY");
        ...
        public DataTable EditProductClassCategory(string ID)
        {
            ProcedureExecute proc;
            int rtrnvalue = 0;
            DataTable dt = new DataTable();
            try
            {
                using (proc = new ProcedureExecute("PRC_MR_PRODUCTCLASSCATEGORY"))
                {
