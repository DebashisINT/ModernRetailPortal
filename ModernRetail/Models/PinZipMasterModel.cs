...
{
    public class PinZipMasterModel
    {
        ...
        public int SavePinZip( string City, string PinZip, string Userid, string ID = "0")
        {
            ...
            try
            {
                ...
                sqlcmd.Parameters.AddWithValue("@city_id", City);
                sqlcmd.Parameters.AddWithValue("@pin_code", PinZip);               
        ...
        public int Delete(string ID)
        {
            int i;
            int rtrnvalue = 0;
            ProcedureExecute proc = new ProcedureExecute("PRC_MR_PINZIPMASTER");
        ...
        public DataTable EditPinZip(string ID)
        {
            ProcedureExecute proc;
            int rtrnvalue = 0;
            DataTable dt = new DataTable();
            try
            {
                using (proc = new ProcedureExecute("PRC_MR_PINZIPMASTER"))
                {
