...
namespace ModernRetail.Models
{
    public class MeasurementModel
    {
        ...
        public int SaveMeasurement(string Measurement,string Userid, string ID = "0", string Description = "")
        {
            ...
            try
            {
                ...
                sqlcmd.Parameters.AddWithValue("@Size_Name", Measurement);
                sqlcmd.Parameters.AddWithValue("@USER_ID", Userid);
                sqlcmd.Parameters.AddWithValue("@ID", ID);
                sqlcmd.Parameters.AddWithValue("@Size_Description", Description);               
        ...
        public int Delete(string Id)
        {
            int i;
            int rtrnvalue = 0;
            ProcedureExecute proc = new ProcedureExecute("PRC_MR_MEASUREMENTS");
        ...
        public DataTable EditMeasurement(string ID)
        {
            ProcedureExecute proc;
            int rtrnvalue = 0;
            DataTable dt = new DataTable();
            try
            {
                using (proc = new ProcedureExecute("PRC_MR_MEASUREMENTS"))
                {
