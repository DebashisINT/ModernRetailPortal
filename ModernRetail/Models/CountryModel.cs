    ...
    public class CountryModel
    {
        ...
        public int SaveCountry(string name, string user, string ID = "0")
        {
            ...
            try
            {
                ...
                sqlcmd.Parameters.AddWithValue("@COUNTRYNAME", name);
        ...
        public int Delete(string Id)
        {
            int i;
            int rtrnvalue = 0;
            ProcedureExecute proc = new ProcedureExecute("PRC_MR_COUNTRYMASTER");
        ...
        public DataTable EditCountry(string ID)
        {
            ...
            try
            {
                using (proc = new ProcedureExecute("PRC_MR_COUNTRYMASTER"))
                {
